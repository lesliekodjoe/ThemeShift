...
const Home = () => {
  return (
    <section>
      <div className="px-5">
        <div className="bg-[#000000] text-white rounded-xl py-14 px-4">
          <div className="flex flex-col items-center justify-center gap-y-8">
            <h1 className="text-2xl text-center font-semibold">Discover Tech Stack, Endless UI Possibilites</h1>
            <p className="text-center text-[14px] px-4">Explore different UI categories with different tech stack and elevate your project.</p>
